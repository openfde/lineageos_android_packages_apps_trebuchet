...
public class Launcher extends StatefulActivity<LauncherState> implements LauncherExterns,
    ...
    public synchronized int addDesktopFiles(int pos,List<Point> listIdle){
        try{
            ...
            if(listIdle == null){
                listIdle = FileUtils.getAllIdlePoints(Launcher.this);
            }
            if(listTexts !=null){
                ...
                try{
                    ...
                    for(ItemInfo item : items){
                        if(item.itemType == LauncherSettings.Favorites.ITEM_TYPE_APPLICATION ||  item.itemType == LauncherSettings.Favorites.ITEM_TYPE_SHORTCUT || item.itemType == LauncherSettings.Favorites.ITEM_TYPE_DEEP_SHORTCUT  ){
                            ...
                            String shareDesktopStr = FileUtils.getSystemProperty(FileUtils.FDE_APP_FUSION,"1");
