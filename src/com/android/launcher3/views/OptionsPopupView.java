...
public class OptionsPopupView<T extends Context & ActivityContext> extends ArrowPopup<T>
    ...
    public static ArrayList<OptionItem> getOptions(Launcher launcher) {
        ...
        if(isShowPasteDlg){
             options.add(new OptionItem(launcher,R.string.desktop_new_paste, R.drawable.ic_paste,
                LAUNCHER_DESKTOP_ICON_TAP_NEW_PASTE,
                OptionsPopupView::startPaste));   
        } 

        options.add(new OptionItem(launcher,R.string.desktop_icon_rearray, R.drawable.ic_apps,
